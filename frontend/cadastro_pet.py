...
def main(page: ft.Page):
    ...
    def atualizar_data(e):
        if e.data:
            data_nascimento_field.value = e.data.strftime("%d/%m/%Y")
            page.update()

    # Componente DatePicker em um Dialog
    ...
    data_nascimento_button = ft.IconButton(
        ...
        icon_size=24,
        icon_color="#BB86FC",
        on_click=lambda e: page.show_dialog(date_picker_dialog),  # Abre o DatePicker como um diálogo
    )
