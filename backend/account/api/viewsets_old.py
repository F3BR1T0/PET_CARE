...
class AccountNotAuthenticatedViewSet(viewsets.GenericViewSet, ResponseMixin):
    def get_serializer_class(self):
        action_serializers = {
            "register": serializers.AccountCreateSerializer,
        ...
        return action_serializers.get(self.action, serializers.AccountCreateSerializer)
...
class AccountAuthenticatedViewSet(viewsets.GenericViewSet, ResponseMixin):
    ...
    def get_serializer_class(self):
        ...
        return action_serializers.get(self.action, serializers.AccountUpdateSerializer)
